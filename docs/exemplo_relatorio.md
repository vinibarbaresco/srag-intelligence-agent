...
- **Execucao (run_id):** `ec99751b-dddd-4d3f-92e4-61607179b636`
- **Gerado em:** 2026-09-17 23:48 Hora oficial do Brasil
...
- **Execucao anterior:** `760c2840-56dd-4c2b-a316-7dc79632721a` (gerada em 2026-09-18T02:37:42, corte 2026-08-23; corte atual 2026-08-23)
...
- **run_id:** `ec99751b-dddd-4d3f-92e4-61607179b636`
- **Eventos registrados:** 24
- **Duracao total:** 15432.94 ms
- **Status dos eventos:** {"ok": 24}
- **Arquivo:** `<repo>\outputs\audit\ec99751b-dddd-4d3f-92e4-61607179b636.jsonl`

Consulta por SQL, sobre todas as execucoes: `SELECT * FROM audit_events WHERE run_id = '<run_id>' ORDER BY seq;` no banco analitico. Ou, no terminal: `python main.py --audit ec99751b-dddd-4d3f-92e4-61607179b636`.
